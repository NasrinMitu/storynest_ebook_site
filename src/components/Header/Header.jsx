    ...
    <header className="w-full bg-[#FFF8F0] shadow-sm">
      ...
      <div className="flex justify-between items-center py-2 px-24 border-b border-muted-gray">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a
            href="#"
            className="text-[#3D2C2E] px-5 py-2 rounded-full font-semibold hover:bg-secondary-accent font-medium transition-colors"
          >
            Sign In
          </a>
        </div>
        ...
        <nav>
          <ul className="flex space-x-8">
            <li>
              {" "}
              <NavLink
                className="text-[#3D2C2E] font-medium hover:text-[#06D6A0] transition-colors"
                to="/"
              >
                {" "}
                Home{" "}
